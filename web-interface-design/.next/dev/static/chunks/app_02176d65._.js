...
function ReferenceHubContent() {
    ...
    const [uploadPriority, setUploadPriority] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("secondary");
    const [uploadNote, setUploadNote] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const updateField = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ReferenceHubContent.useCallback[updateField]": (id, field, value)=>{
            setRefs({
                "ReferenceHubContent.useCallback[updateField]": (prev)=>prev.map({
                        "ReferenceHubContent.useCallback[updateField]": (r)=>r.id === id ? {
                                ...r,
                                [field]: value
                            } : r
                    }["ReferenceHubContent.useCallback[updateField]"])
            }["ReferenceHubContent.useCallback[updateField]"]);
        }
    }["ReferenceHubContent.useCallback[updateField]"], []);
    const saveRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ReferenceHubContent.useCallback[saveRef]": async (id, updates)=>{
            setSaveStates({
                "ReferenceHubContent.useCallback[saveRef]": (prev)=>({
                        ...prev,
                        [id]: "saving"
                    })
            }["ReferenceHubContent.useCallback[saveRef]"]);
            try {
                ...
                setTimeout({
                    "ReferenceHubContent.useCallback[saveRef]": ()=>setSaveStates({
                            "ReferenceHubContent.useCallback[saveRef]": (prev)=>({
                                    ...prev,
                                    [id]: "idle"
                                })
                        }["ReferenceHubContent.useCallback[saveRef]"])
                }["ReferenceHubContent.useCallback[saveRef]"], 1500);
            } catch  {
                setSaveStates({
                    "ReferenceHubContent.useCallback[saveRef]": (prev)=>({
                            ...prev,
...
//# sourceMappingURL=app_02176d65._.js.map